...
final class Version20180829012700 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE orders (id SERIAL NOT NULL, user_id INT NOT NULL, partner_id INT DEFAULT NULL, district_id INT DEFAULT NULL, updated_by_id INT NOT NULL, location_id INT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, status VARCHAR(16) NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, scheduled_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, is_schedule_approved BOOLEAN NOT NULL, price INT NOT NULL, repeatable VARCHAR(16) DEFAULT NULL, PRIMARY KEY(id))');
